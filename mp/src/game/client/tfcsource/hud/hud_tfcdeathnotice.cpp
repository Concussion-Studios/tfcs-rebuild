...
class TFCHudDeathNotice : public CHudBaseDeathNotice
{
	DECLARE_CLASS_SIMPLE( TFCHudDeathNotice, CHudBaseDeathNotice );
public:
	TFCHudDeathNotice( const char *pElementName ) : CHudBaseDeathNotice( pElementName ) {};
...
DECLARE_HUDELEMENT( TFCHudDeathNotice );

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void TFCHudDeathNotice::Init( void )
{
	BaseClass::Init();
...
//-----------------------------------------------------------------------------
/*void TFCHudDeathNotice::FireGameEvent( IGameEvent *event )
{
...
//-----------------------------------------------------------------------------
void TFCHudDeathNotice::OnGameEvent( IGameEvent *event, int iDeathNoticeMsg )
{
	const char *pszEventName = event->GetName();
...
//-----------------------------------------------------------------------------
void TFCHudDeathNotice::AddAdditionalMsg( int iKillerID, int iVictimID, const char *pMsgKey )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void TFCHudDeathNotice::Paint()
{
	// Retire any death notices that have expired
	RetireExpiredDeathNotices();

	int yStart = GetClientModeTFCNormal()->GetDeathMessageStartHeight();
...
//-----------------------------------------------------------------------------
Color TFCHudDeathNotice::GetTeamColor( int iTeamNumber, bool bLocalPlayerInvolved /* = false */ )
{
	switch ( iTeamNumber )
	{
	case TEAM_BLUE:
