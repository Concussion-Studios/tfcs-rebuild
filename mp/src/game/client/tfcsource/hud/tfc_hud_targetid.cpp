...
// Purpose: 
//-----------------------------------------------------------------------------
class CTFCTargetId : public CHudElement, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CTFCTargetId, vgui::Panel );

public:
	CTFCTargetId( const char *pElementName );
	void Init( void );
...
DECLARE_HUDELEMENT( CTFCTargetId );
...
// Purpose: 
//-----------------------------------------------------------------------------
CTFCTargetId::CTFCTargetId( const char *pElementName ) :
...
// Purpose: Setup
//-----------------------------------------------------------------------------
void CTFCTargetId::Init( void )
{
};

void CTFCTargetId::ApplySchemeSettings( vgui::IScheme *scheme )
{
...
Color CTFCTargetId::GetColorForTargetTeam( int iTeamNumber )
{
...
#define MAX_ID_STRING 256
	...
	if ( iEntIndex )
	{
		...
		if ( IsPlayerIndex( iEntIndex ) )
		{
			...
			if ( TFCGameRules()->IsTeamplay() == true && pPlayer->InSameTeam(pLocalPlayer) )
			{
				printFormatString = "#TFC_Playerid_sameteam";
				bShowHealth = true;
			}
			else
			{
				printFormatString = "#TFC_Playerid_diffteam";
			}
