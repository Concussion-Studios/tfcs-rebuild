...
#ifndef TFC_SCOREBOARD_H
#define TFC_SCOREBOARD_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CTFCScoreboard : public CClientScoreBoardDialog
{
private:
	DECLARE_CLASS_SIMPLE( CTFCScoreboard, CClientScoreBoardDialog );

public:
	CTFCScoreboard( IViewPort *pViewPort );
	~CTFCScoreboard();
...
private:
	...
	static bool TFCPlayerSortFunc( vgui::SectionedListPanel *list, int itemID1, int itemID2 );
