...
#ifndef CTFCSPECTATORGUI_H
#define CTFCSPECTATORGUI_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CTFCSpectatorGUI : public CSpectatorGUI
{
private:
	DECLARE_CLASS_SIMPLE( CTFCSpectatorGUI, CSpectatorGUI );

public:
	CTFCSpectatorGUI( IViewPort *pViewPort );
...
class CTFCMapOverview : public CMapOverview
{
	DECLARE_CLASS_SIMPLE( CTFCMapOverview, CMapOverview );
...
public:	
	...
	CTFCMapOverview( const char *pElementName );
	virtual ~CTFCMapOverview();
...
private:
	bool			DrawIconTFC(	int textureID,
	...
	TFCMapPlayer_t* GetTFCInfoForPlayerIndex( int index );
	TFCMapPlayer_t* GetTFCInfoForPlayer(MapPlayer_t *player);

	TFCMapPlayer_t	m_PlayersTFCInfo[MAX_PLAYERS];
