...
BEGIN_DATADESC( CTFCSSpawnPoint )
...
LINK_ENTITY_TO_CLASS( info_player_teamspawn, CTFCSSpawnPoint );

IMPLEMENT_AUTO_LIST( ITFCSSpawnPointAutoList )

//-----------------------------------------------------------------------------
// Purpose: Constructor.
//-----------------------------------------------------------------------------
CTFCSSpawnPoint::CTFCSSpawnPoint()
{
	m_bDisabled = false;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFCSSpawnPoint::Spawn( void )
{
	BaseClass::Spawn();
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFCSSpawnPoint::Activate( void )
{
	BaseClass::Activate();
...
// Purpose:
//-----------------------------------------------------------------------------
void CTFCSSpawnPoint::InputEnable( inputdata_t &inputdata )
{
	m_bDisabled = false;
}
...
// Purpose:
//-----------------------------------------------------------------------------
void CTFCSSpawnPoint::InputDisable( inputdata_t &inputdata )
{
	m_bDisabled = true;
}
...
//-----------------------------------------------------------------------------
int CTFCSSpawnPoint::DrawDebugTextOverlays(void) 
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFCSSpawnPoint::InputRoundSpawn( inputdata_t &input )
{
