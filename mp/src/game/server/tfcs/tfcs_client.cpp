...
void FinishClientPutInServer( CTFCSPlayer *pPlayer )
{
	{
...
{
	// Allocate a CTFCSPlayer for pev, and call spawn
	CTFCSPlayer *pPlayer = CTFCSPlayer::CreatePlayer( "player", pEdict );
...
void ClientActive( edict_t *pEdict, bool bLoadGame )
{
	...
	CTFCSPlayer *pPlayer = ToTFCSPlayer( CBaseEntity::Instance( pEdict ) );
...
{
	CreateGameRulesObject( "CTFCSGameRules" );
}
