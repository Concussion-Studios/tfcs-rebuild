...
class CTFCSPlayerMove : public CPlayerMove
{
	DECLARE_CLASS( CTFCSPlayerMove, CPlayerMove );
public:
	CTFCSPlayerMove() : m_bWasInVehicle( false ), m_bVehicleFlipped( false ), m_bInGodMode( false ), m_bInNoClip( false ) { m_vecSaveOrigin.Init(); }
...
static CTFCSPlayerMove g_PlayerMove;
...
void CTFCSPlayerMove::SetupMove( CBasePlayer *player, CUserCmd *ucmd, IMoveHelper *pHelper, CMoveData *move )
{
...
void CTFCSPlayerMove::FinishMove( CBasePlayer *player, CUserCmd *ucmd, CMoveData *move )
{
