...
void TFCSPlayerClassInfo_t::Parse(KeyValues *pKeyValuesData, const char *pszClassName)
{	
...
//FilePlayerClassInfo_t* CreatePlayerClassInfo() { return new CTFCSPlayerClassInfo; }
//
//CTFCSPlayerClassInfo::CTFCSPlayerClassInfo()
//{
//	m_szArmsModel[0] = '\0';
//	m_szLimitCvar[0] = '\0';
//
...
//}
//
//void CTFCSPlayerClassInfo::Parse(KeyValues *pKeyValuesData, const char *szClassName)
//{
