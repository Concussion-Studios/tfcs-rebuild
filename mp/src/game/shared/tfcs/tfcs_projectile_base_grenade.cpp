#include "cbase.h"
#include "tfcs_projectile_base_grenade.h"
...
BEGIN_DATADESC( CTFCSWeaponBaseGrenadeProj )
	// Fields
...
IMPLEMENT_NETWORKCLASS_ALIASED( TFCSWeaponBaseGrenadeProj, DT_TFCSWeaponBaseGrenadeProj )

BEGIN_NETWORK_TABLE( CTFCSWeaponBaseGrenadeProj, DT_TFCSWeaponBaseGrenadeProj )
#ifdef CLIENT_DLL
...
END_NETWORK_TABLE()
	...
	void CTFCSWeaponBaseGrenadeProj::PostDataUpdate( DataUpdateType_t type )
	{
	...
	int CTFCSWeaponBaseGrenadeProj::DrawModel( int flags )
	{
...
//				}
	...
	void CTFCSWeaponBaseGrenadeProj::Spawn()
	{
		m_flSpawnTime = gpGlobals->curtime;
		BaseClass::Spawn();
	}

	void CTFCSWeaponBaseGrenadeProj::Precache()
	{
		BaseClass::Precache();
	}
	...
	void CTFCSWeaponBaseGrenadeProj::Spawn( void )
	{
		BaseClass::Spawn();
	...
	void CTFCSWeaponBaseGrenadeProj::SetVelocity( const Vector &velocity, const AngularImpulse &angVelocity )
	{
...
// this will hit only things that are in newCollisionGroup, but NOT in collisionGroupAlreadyChecked
	...
	void CTFCSWeaponBaseGrenadeProj::VPhysicsUpdate( IPhysicsObject *pPhysics )
	{
	...
	bool CTFCSWeaponBaseGrenadeProj::CreateVPhysics()
	{
	...
	void CTFCSWeaponBaseGrenadeProj::CreateEffects( void )
	{
		CTFCSPlayer *pPlayer = ToTFCSPlayer( GetThrower() );
		if ( !pPlayer )
			return;
	...
	int CTFCSWeaponBaseGrenadeProj::OnTakeDamage( const CTakeDamageInfo &inputInfo )
	{
	...
	void CTFCSWeaponBaseGrenadeProj::DangerSoundThink( void )
	{
		if (!IsInWorld())
		{
			Remove( );
	...
	void CTFCSWeaponBaseGrenadeProj::SetDetonateTimerLength( float timer )
	{
	...
	void CTFCSWeaponBaseGrenadeProj::ResolveFlyCollisionCustom( trace_t &trace, Vector &vecVelocity )
	{
	...
	void CTFCSWeaponBaseGrenadeProj::SetupInitialTransmittedGrenadeVelocity( const Vector &velocity )
	{
		m_vInitialVelocity = velocity;
	}

	void CTFCSWeaponBaseGrenadeProj::Splash()
	{
