#ifndef TFCS_PROJECTILE_BASE_GRENADE_H
#define TFCS_PROJECTILE_BASE_GRENADE_H
#ifdef _WIN32
#pragma once
#endif
...
#ifdef CLIENT_DLL
	#define CTFCSWeaponBaseGrenadeProj C_TFCSWeaponBaseGrenadeProj
#endif


class CTFCSWeaponBaseGrenadeProj : public CBaseGrenade
{
public:
	DECLARE_CLASS( CTFCSWeaponBaseGrenadeProj, CBaseGrenade );
...
public:
	...
	virtual int GetWeaponID( void ) { return WEAPON_NONE; }
...
#ifdef CLIENT_DLL
	CTFCSWeaponBaseGrenadeProj() {}
	CTFCSWeaponBaseGrenadeProj( const CTFCSWeaponBaseGrenadeProj& ) {}
...
#endif // TFCS_PROJECTILE_BASE_GRENADE_H
