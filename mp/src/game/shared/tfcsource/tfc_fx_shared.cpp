	...
	)
{
...
#ifdef CLIENT_DLL
	C_TFCPlayer *pPlayer = ToTFCPlayer( ClientEntityList().GetBaseEntity( iPlayerIndex ) );
#else
	CTFCPlayer *pPlayer = ToTFCPlayer( UTIL_PlayerByIndex( iPlayerIndex) );
#endif
	...
	CTFCWeaponInfo *pWeaponInfo = static_cast< CTFCWeaponInfo* >( GetFileWeaponInfoFromHandle( hWpnInfo ) );
